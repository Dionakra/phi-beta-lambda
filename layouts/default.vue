    ...
    <nav class="flex items-center justify-between pt-3">
      ...
      >
        ...
        <div class="text-sm md:flex-grow">
          <nuxt-link
            class="no-underline block mt-auto sm:inline-block sm:mt-0 text-teal-lighter hover:text-red mr-2"
            to="presentadores"
          ...
          >Invitados</nuxt-link>
          <nuxt-link
            class="no-underline block mt-auto sm:inline-block sm:mt-0 text-teal-lighter hover:text-red"
            to="comicos"
          >Cómicos</nuxt-link>
        </div>
        <!-- END LOCAL PAGES -->
        ...
        <div>
          <a target="_blank" href="https://www.youtube.com/channel/UCFKcIYyLxfQBAD4r0Bq1RfA">
            <svg
              ...
              viewBox="0 0 20 20"
              class="youtube h-6 block mt-auto sm:inline-block mr-2"
            >
              <path
          ...
          <a target="_blank" href="https://twitter.com/ComediaPerpetua">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              class="twitter h-6 block mt-auto sm:inline-block mr-2"
            >
              <path
                d="M17.316 6.246l.01.488c0 5-3.797 10.742-10.74 10.742-2.133 0-4.116-.625-5.787-1.697a7.66 7.66 0 0 0 .9.053c1.77 0 3.397-.604 4.688-1.615a3.78 3.78 0 0 1-3.526-2.621 3.86 3.86 0 0 0 .71.066c.345 0 .68-.045.995-.13a3.78 3.78 0 0 1-3.028-3.703V7.78c.51.283 1.092.453 1.7.473-1.013-.678-1.68-1.832-1.68-3.143a3.75 3.75 0 0 1 .512-1.898C3.942 5.498 6.725 7 9.862 7.158c-.064-.277-.097-.564-.097-.86 0-2.084 1.69-3.773 3.774-3.773a3.77 3.77 0 0 1 2.756 1.191 7.6 7.6 0 0 0 2.397-.916 3.79 3.79 0 0 1-1.66 2.088 7.55 7.55 0 0 0 2.168-.594c-.506.758-1.146 1.422-1.884 1.953z"
              />
            </svg>
          </a>
          <a target="_blank" href="https://www.instagram.com/phi.beta.lambda/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 18 18"
              class="instagram h-6 block mt-auto sm:inline-block mr-2"
            >
              <path
          ...
          <a target="_blank" href="https://www.facebook.com/PhiBetaLambda.Comedy/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              class="facebook h-6 block mt-auto sm:inline-block"
            >
              <path
                d="M17 1H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h7v-7H8V9.525h2v-2.05c0-2.164 1.212-3.684 3.766-3.684l1.803.002v2.605h-1.197c-.994 0-1.372.746-1.372 1.438v1.7h2.568L15 12h-2v7h4c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2z"
              />
            </svg>
          </a>
        </div>
